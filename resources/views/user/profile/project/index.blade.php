                ...
                @if ($project->isNotEmpty())
                    <ul class="list-group">
                        ...
                        <li class="list-group-item city-item position-relative">
                            {{-- @if ($projectt->media)
                                <img src="{{ asset($projectt->media) }}" alt="Profile Picture" class="img-fluid profile-picture">
                            @else
                                <span>Add Your Media</span>
                            @endif --}}
                            <img src="{{ asset($projectt->media) }}" alt="Profile Picture" class="img-fluid profile-picture">
                            <span class="kaem-heading">{{ $projectt->project_name ?? 'Unknown Project' }}</span><br>
                            <span class="kaem-subheading">{{ $projectt->description }}</span><br>
...
<div class="modal fade" id="addProjectModal" tabindex="-1" role="dialog" aria-labelledby="addEducationLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
