<form action="{{ route('storeEmergency') }}" method="POST">
    @csrf
        ...
        <div class="form-group">
            ...
            <input name="emergency_name" type="text" class="form-control kaem-sub form-control-user"
        ...
        <div class="form-group">
            ...
            <input name="emergency_relation" type="text" class="form-control kaem-sub form-control-user"
        ...
        <div class="form-group">
            ...
            <input name="emergency_phone" type="number" class="form-control kaem-sub form-control-user"
