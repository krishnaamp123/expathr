...
<!-- Modal Component -->
<div class="modal fade" id="editUserRatingsmModal{{ $id }}" tabindex="-1" aria-labelledby="editUserRatingsmModalLabel{{ $id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editUserRatingsmModalLabel{{ $id }}">Update Rating User Interview</h5>
