...
@section('title', 'Add User Interview')
@section('content')
        ...
        <div class="col-12 col-md-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold" style="color: #72A28A;">Add User Interview</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('storeUserInterview') }}" method="post" enctype="multipart/form-data">
                        @csrf
