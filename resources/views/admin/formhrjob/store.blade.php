        ...
        <div class="col-12 col-md-6">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold" style="color: #72A28A;">Add New Job</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('storeFormHrjob') }}" method="post" enctype="multipart/form-data">
                        @csrf
